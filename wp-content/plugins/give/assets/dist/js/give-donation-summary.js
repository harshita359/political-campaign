(() => {
    ...
    window.GiveDonationSummary = {
        ...
        initAmount: function() {
            ...
            var e = document.querySelector('[name="give-amount"]');
            if (e) {
                var n = jQuery(e.closest(".give-form"));
        ...
        handleAdminDefinedRecurringFrequency: function(e, n) {
            ...
            if (i) {
                ...
                if (void 0 !== r.multi) {
                    var a = "yes" === r.multi[t]._give_recurring,
                        o = r.multi[t].give_recurring_pretty_text;
                    n.find(".js-give-donation-summary-frequency-help-text").toggle(!a), n.find('[data-tag="frequency"]').toggle(!a), n.find('[data-tag="recurring"]').toggle(a).html(o)
                }
            }
        },
        ...
        observe: function(n, t) {
            ...
            if (r) {
                var a = jQuery(r.closest(".give-form"));
                new MutationObserver((function(n) {
                    var i, r = e(n);
                    try {
                        for (r.s(); !(i = r.n()).done;) {
                            var o = i.value;
                            "attributes" === o.type && t(o.target, a)
                        }
                    } catch (e) {
                        r.e(e)
                    } finally {
